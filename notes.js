...
function margin(){
    var random_margin = ['-15px', '1px', '5px','15px','10px', '20px'];  // to generate a random number
...
function rotate(){
    var random_rotate = ['rotate(3deg)','rotate(1deg)','rotate(-1deg)','rotate.-3deg)','rotate(-5deg)','rotate(-10deg)'];  // to generate a rotation degree
